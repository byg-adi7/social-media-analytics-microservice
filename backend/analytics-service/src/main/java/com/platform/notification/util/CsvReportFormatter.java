...
public final class CsvReportFormatter {
    ...
    public static String forPlatformComparison(List<PlatformMetricsResponse> metrics) {
        StringBuilder csv = new StringBuilder(
                "platform,followers,views,likes,comments,shares,posts,engagementRate,growthRate\n");
        for (PlatformMetricsResponse m : metrics) {
    ...
    public static String forSummary(AnalyticsSummaryResponse summary) {
        return "metric,value\n"
